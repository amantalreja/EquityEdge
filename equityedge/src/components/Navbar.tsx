  ...
  return (
    <div className="navbar bg-base-200 sticky top-0 z-30">
      <div className="flex-1">
        {/* Hamburger menu button for mobile (controls the drawer) */}
        <label htmlFor="my-drawer-2" className="btn btn-ghost drawer-button lg:hidden">
          <svg xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-6 h-6 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
        </label>
      ...
      <div className="flex-none gap-4">
        ...
        <div className="dropdown dropdown-end">
          <button tabIndex={0} className="btn btn-ghost btn-circle" aria-label="notifications">
        ...
        {/* Profile Dropdown - Renders only if user is logged in */}
        {user && (
          <div className="dropdown dropdown-end">
            <button tabIndex={0} className="btn btn-ghost btn-circle avatar" aria-label="open profile menu">
